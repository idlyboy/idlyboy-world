...
const telegramIcon = getImageKitUrl('6b224fb116e0caa3076a021ae6c5e57427d9b894.png', 'thumbnail');
const amplitudeLogo = getImageKitUrl('372acaaf8adf70ed5b3d005b609ac106043f4128.png', 'thumbnail');
const figmaLogo = getImageKitUrl('2bb6cb2d4dff2cca9e7b0eb0110f8acac9ebf519.png', 'thumbnail');
const chatgptLogo = getImageKitUrl('68f23de2bd5734f8e24655571d20f47cdfbb9d60.png', 'thumbnail');
const jiraLogo = getImageKitUrl('0b7e55b840e033a7ac832270c171ae6cdbbc406d.png', 'thumbnail');
const etherscanLogo = getImageKitUrl('c0767c776d80904df3ca4f053cde3e4a321a50cf.png', 'thumbnail');
const adobeLogo = getImageKitUrl('d6961e7af8c29d7b9b852f65aa2d369f2e816e39.png', 'thumbnail');
const defillamaLogo = getImageKitUrl('20e638b6781b1accf1eb0f1c8a7447e887529c00.png', 'thumbnail');
const duneLogo = getImageKitUrl('bc1efdeea92fdb2470b2dea1a8dbe2bf6d59cc0c.png', 'thumbnail');
const potpieLogo = getImageKitUrl('67912ee6fd693dc6c36117524ea8e2931e8e2c2d.png', 'thumbnail');
