...
// Design images from Cloudinary (thumbnail size for grid, original for modal)
const nightLiFiPerpsOrderbook = getCloudinaryUrl("night_LI.FI Perps - Orderbook.png", "thumbnail");
const nightKlerosScoutLandingPageBuilders = getCloudinaryUrl("night_Kleros Scout Landing Page - Builders.png", "thumbnail");
const nightRabbyPayWithLinks = getCloudinaryUrl("night_Rabby - Pay with links.png", "thumbnail");
const nightButterWalletPayWithLink = getCloudinaryUrl("night_Butter Wallet - Pay with Link.png", "thumbnail");
const nightCausalityNetworkRecord = getCloudinaryUrl("night_Causality Network - Record.png", "thumbnail");
const nightDEXSwap = getCloudinaryUrl("night_DEX swap.png", "thumbnail");
const nightGrantLinkBiconomyEcosystemGrants = getCloudinaryUrl("night_GrantLink - Biconomy Ecosystem Grants Rd 2.png", "thumbnail");
const nightGrantLinkBiconomyHome = getCloudinaryUrl("night_GrantLink - Biconomy Home.png", "thumbnail");
const nightKlerosScoutUsers = getCloudinaryUrl("night_Kleros Scout - Users.png", "thumbnail");
const nightKlerosScoutTokensApp = getCloudinaryUrl("night_Kleros Scout Tokens App.png", "thumbnail");
const nightLiFiPerpsChart = getCloudinaryUrl("night_LI.FI Perps - Chart.png", "thumbnail");
const nightLegalFlowCasesDashboard = getCloudinaryUrl("night_LegalFlow - Cases Dashboard.png", "thumbnail");
const nightLegalFlowPromptBuilder = getCloudinaryUrl("night_LegalFlow - Prompt Builder.png", "thumbnail");
const nightBookwormFeed = getCloudinaryUrl("night_Bookworm - Feed.png", "thumbnail");
const nightPratilipiHomepage = getCloudinaryUrl("night_Pratilipi - Homepage.png", "thumbnail");
const nightPratilipiLanguageSelection = getCloudinaryUrl("night_Pratilipi - Language Selection.png", "thumbnail");
const nightPratilipiNewHomepage = getCloudinaryUrl("night_Pratilipi - New Homepage.png", "thumbnail");
const nightBookwormDiscoverBooks = getCloudinaryUrl("night_Bookworm - Discover Books.png", "thumbnail");
const nightPratilipiOnboarding = getCloudinaryUrl("night_Pratilipi - Onboarding.png", "thumbnail");
const nightRentomojoCategories = getCloudinaryUrl("night_Rentomojo - Categories.png", "thumbnail");
const nightRentomojoProfile = getCloudinaryUrl("night_Rentomojo - Profile.png", "thumbnail");
const nightRwaziElaChat = getCloudinaryUrl("night_Rwazi - Ela Chat.png", "thumbnail");
const nightRwaziElaIntro = getCloudinaryUrl("night_Rwazi - Ela Intro.png", "thumbnail");
const nightRwaziHome = getCloudinaryUrl("night_Rwazi Home.png", "thumbnail");
const nightTringNotificationWidget = getCloudinaryUrl("night_Tring - Notification Widget.png", "thumbnail");
const nightTringOnboarding = getCloudinaryUrl("night_Tring - Onboarding.png", "thumbnail");
const nightTringPermission = getCloudinaryUrl("night_Tring - Permission.png", "thumbnail");
const nightBookwormClubs = getCloudinaryUrl("night_Bookworm - Clubs.png", "thumbnail");
