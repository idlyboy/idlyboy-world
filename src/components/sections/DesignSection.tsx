...
// Design images from ImageKit (thumbnail size for grid, medium for modal)
const nightLiFiPerpsOrderbook = getImageKitUrl("night_LI.FI Perps - Orderbook.png", "thumbnail");
const nightKlerosScoutLandingPageBuilders = getImageKitUrl("night_Kleros Scout Landing Page - Builders.png", "thumbnail");
const nightRabbyPayWithLinks = getImageKitUrl("night_Rabby - Pay with links.png", "thumbnail");
const nightButterWalletPayWithLink = getImageKitUrl("night_Butter Wallet - Pay with Link.png", "thumbnail");
const nightCausalityNetworkRecord = getImageKitUrl("night_Causality Network - Record.png", "thumbnail");
const nightDEXSwap = getImageKitUrl("night_DEX swap.png", "thumbnail");
const nightGrantLinkBiconomyEcosystemGrants = getImageKitUrl("night_GrantLink - Biconomy Ecosystem Grants Rd 2.png", "thumbnail");
const nightGrantLinkBiconomyHome = getImageKitUrl("night_GrantLink - Biconomy Home.png", "thumbnail");
const nightKlerosScoutUsers = getImageKitUrl("night_Kleros Scout - Users.png", "thumbnail");
const nightKlerosScoutTokensApp = getImageKitUrl("night_Kleros Scout Tokens App.png", "thumbnail");
const nightLiFiPerpsChart = getImageKitUrl("night_LI.FI Perps - Chart.png", "thumbnail");
const nightLegalFlowCasesDashboard = getImageKitUrl("night_LegalFlow - Cases Dashboard.png", "thumbnail");
const nightLegalFlowPromptBuilder = getImageKitUrl("night_LegalFlow - Prompt Builder.png", "thumbnail");
const nightBookwormFeed = getImageKitUrl("night_Bookworm - Feed.png", "thumbnail");
const nightPratilipiHomepage = getImageKitUrl("night_Pratilipi - Homepage.png", "thumbnail");
const nightPratilipiLanguageSelection = getImageKitUrl("night_Pratilipi - Language Selection.png", "thumbnail");
const nightPratilipiNewHomepage = getImageKitUrl("night_Pratilipi - New Homepage.png", "thumbnail");
const nightBookwormDiscoverBooks = getImageKitUrl("night_Bookworm - Discover Books.png", "thumbnail");
const nightPratilipiOnboarding = getImageKitUrl("night_Pratilipi - Onboarding.png", "thumbnail");
const nightRentomojoCategories = getImageKitUrl("night_Rentomojo - Categories.png", "thumbnail");
const nightRentomojoProfile = getImageKitUrl("night_Rentomojo - Profile.png", "thumbnail");
const nightRwaziElaChat = getImageKitUrl("night_Rwazi - Ela Chat.png", "thumbnail");
const nightRwaziElaIntro = getImageKitUrl("night_Rwazi - Ela Intro.png", "thumbnail");
const nightRwaziHome = getImageKitUrl("night_Rwazi Home.png", "thumbnail");
const nightTringNotificationWidget = getImageKitUrl("night_Tring - Notification Widget.png", "thumbnail");
const nightTringOnboarding = getImageKitUrl("night_Tring - Onboarding.png", "thumbnail");
const nightTringPermission = getImageKitUrl("night_Tring - Permission.png", "thumbnail");
const nightBookwormClubs = getImageKitUrl("night_Bookworm - Clubs.png", "thumbnail");
