...
export function GrowingMatchaDexVolumeShareContent() {
  return (
    <>
      ...
      <Image
        src={getImageKitUrl('matcha search bar and modal.png', 'medium')}
        alt="Matcha Search Bar and Modal"
        caption="Matcha Search Bar and Modal"
      />
      ...
      <Image
        src={getImageKitUrl('matcha token list.png', 'medium')}
        alt="Matcha Token List"
        caption="Matcha Token List"
      />
      ...
      <Image
        src={getImageKitUrl('matcha connect wallet.png', 'medium')}
        alt="Matcha Connect Wallet"
        caption="Matcha Connect Wallet"
      />
      ...
      <Image
        src={getImageKitUrl('matcha swap interface 1.png', 'medium')}
        alt="Matcha Swap Interface 1"
        caption="Matcha Swap Interface 1"
      />

      <Image
        src={getImageKitUrl('matcha swap interface 2.png', 'medium')}
        alt="Matcha Swap Interface 2"
        caption="Matcha Swap Interface 2"
      />
      ...
      <Image
        src={getImageKitUrl('matcha swap interface 3.png', 'medium')}
        alt="Matcha Swap Interface 3"
        caption="Matcha Swap Interface 3"
      />

      <Image
        src={getImageKitUrl('matcha swap interface 4.png', 'medium')}
        alt="Matcha Swap Interface 4"
        caption="Matcha Swap Interface 4"
      />
      ...
      <Image
        src={getImageKitUrl('matcha txn pending.png', 'medium')}
        alt="Matcha Transaction Pending"
        caption="Matcha Transaction Pending"
      />

      <Image
        src={getImageKitUrl('matcha trade details.png', 'medium')}
        alt="Matcha Trade Details"
        caption="Matcha Trade Details"
      />
